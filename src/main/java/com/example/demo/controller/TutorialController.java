...
public class TutorialController {
    ...
    public ResponseEntity<List<Tutorial>> getTutorialbyPublished(){
        List<Tutorial> tutorialPublished = tutorialRepository.findByPublished(true);

        if(tutorialPublished == null){
            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
        }
        return new ResponseEntity<>(tutorialPublished, HttpStatus.OK);
    }

    @GetMapping("/tutorials?title=[keyword]")
